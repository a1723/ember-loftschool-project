...
;define("ember-loftschool-project/controllers/author", ["exports", "@ember/controller"], function (_exports, _controller) {
  "use strict";
...
;define("ember-loftschool-project/routes/author", ["exports", "@ember/routing/route", "@ember/service"], function (_exports, _route, _service) {
  "use strict";
...
;define("ember-loftschool-project/services/data-service", ["exports", "@ember/service", "@ember/application"], function (_exports, _service, _application) {
  "use strict";
  ...
  class DataServiceService extends _service.default {
    async readAuthors() {
      ...
      let url = (0, _application.getOwner)(this).application;
...
;
          if (!runningTests) {
            require("ember-loftschool-project/app")["default"].create({"backEndURL":"http://localhost:3000","name":"ember-loftschool-project","version":"0.0.0+67ca83d9"});
          }
